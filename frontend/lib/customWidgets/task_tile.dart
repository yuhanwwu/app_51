...
class _TaskTileState extends State<TaskTile> {
  ...
  Future<void> _claimTask() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Error claiming task: $e')));
    }
    widget.onDone();
  }
  ...
  Future<void> _markDone(DocumentReference nextUser) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Error marking task as done: $e')));
    }
    widget.onDone();
  }
    ...
    return ListTile(
      ...
      title: Text(
        ...
        style: TextStyle(
          ...
          decoration: task.isOneOff && task.done! ? TextDecoration.lineThrough : null,
        ),
      ),
      trailing: Row(
